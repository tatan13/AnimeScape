...
@section('title')
    <title>クリエイターの追加申請 AnimeScape -アニメ批評空間-</title>
...
@section('main')
    <article class="add_creater_request">
        ...
        @endif
        <form action="{{ route('add_creater_request.post') }}" class="add_creater_request_form" method="POST">
            @csrf
            <input type="submit" value="送信">
            <table class="add_creater_request_table">
                <tbody>
                    <tr>
                        <th>項目</th>
                        <th>情報</th>
