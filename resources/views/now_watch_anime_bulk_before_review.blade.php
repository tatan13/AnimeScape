...
@section('title')
    <title>視聴中アニメの視聴完了前データ一括入力 AnimeScape -アニメ批評空間-</title>
    <meta name="robots" content="noindex,nofollow">
@endsection

@section('main')
    <article class="now_watch_anime_bulk_before_review">
        <h1>視聴中アニメの視聴完了前データ一括入力</h1>
        @if ($errors->any())
        ...
        <section class="search_parameters">
            ...
            <a href="{{ route('now_watch_anime_bulk_before_review.show') }}">絞り込み解除</a>
        </section>
        <section class="now_watch_anime_bulk_before_review_information">
            <h2>注意事項</h2>
