            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div id="menulist">
                        ...
                        <ul>
                            <li>
                                <form action="{{ route('all_statistics', ['category' => 1]) }}" name="all_statistics" method="get">
                                    @csrf
                                    <a href="javascript:all_statistics.submit()">すべて</a>
                                </form>
                            </li>
                            <form action="{{ route('year_statistics', ['category' => 1]) }}" name="year_statistics" method="get">
                                @csrf
                            ...
                            <form action="{{ route('coor_statistics', ['category' => 1]) }}" name="coor_statistics" method="get">
                                @csrf
