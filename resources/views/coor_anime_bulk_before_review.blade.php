...
@section('main')
    <article class="coor_anime_bulk_before_review">
        ...
        <section class="coor_anime_bulk_before_review_information">
            ...
            <form action="{{ route('coor_anime_bulk_before_review.show') }}" name="previous" class="d-inline"
                method="get">
                @csrf
            ...
            <form action="{{ route('coor_anime_bulk_before_review.show') }}" name="next" class="d-inline"
                method="get">
                @csrf
            ...
            @endif
            <form action="{{ route('coor_anime_bulk_before_review.post') }}" class="coor_anime_bulk_before_review_form"
                method="POST">
                @csrf
