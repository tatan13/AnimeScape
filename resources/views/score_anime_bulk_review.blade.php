...
@section('title')
    <title>得点入力済みアニメのデータ一括入力 AnimeScape -アニメ批評空間-</title>
    <meta name="robots" content="noindex,nofollow">
@endsection

@section('main')
    <article class="score_anime_bulk_review">
        <h1>得点入力済みアニメのデータ一括入力</h1>
        @if ($errors->any())
        ...
        <section class="search_parameters">
            ...
            <a href="{{ route('score_anime_bulk_review.show') }}">絞り込み解除</a>
        </section>
        <section class="score_anime_bulk_review_information">
            <h2>注意事項</h2>
