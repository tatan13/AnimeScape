...
@section('main')
    <article class="anime_review">
        ...
        <form action="{{ route('anime_review.post', ['id' => $anime->id]) }}" class="anime_review_form" method="POST">
            ...
            <input type="checkbox" name="will_watch" class="will_watch" value="1" id="will_watch"
            ...
            <input type="checkbox" name="watch" class="watch" value="1" id="watch"
            ...
            <input type="checkbox" name="spoiler" class="spoiler" value="1" id="spoiler"
