...
@section('main')
    <article class="modify_anime_request">
        ...
        @endif
        <form action="{{ route('modify_anime_request.post', ['anime_id' => $anime->id]) }}" class="modify_anime_request_form"
            method="POST">
            @csrf
                ...
                <table class="modify_anime_request_table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="number_of_episode" value="{{ $anime->number_of_episode }}">
                            </td>
                        </tr>
                        <tr>
                            <th>公式HPのURL</th>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="amazon_prime_video_id"
                                    value="{{ $anime->amazon_prime_video_id }}">
                            </td>
                        </tr>
                        <tr>
                            <th>FODのID</th>
                        ...
                        <tr>
                            ...
                            <td>{{ $anime->summary }}</td>
                            <td>
                                <textarea name="summary" class="summary" rows="3" cols="100">{{ $anime->summary }}</textarea><br>
                            </td>
                        </tr>
                        <tr>
                            <th>事由</th>
