                        ...
                        <table class="modify_anime_request_list_table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="furigana" value="{{ $modify_anime_request->furigana }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>略称</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="coor">
                                            <option value="1"
                                                {{ $modify_anime_request->coor == 1 ? 'selected' : '' }}>冬
                                            </option>
                                            <option value="2"
                                                {{ $modify_anime_request->coor == 2 ? 'selected' : '' }}>春
                                            </option>
                                            <option value="3"
                                                {{ $modify_anime_request->coor == 3 ? 'selected' : '' }}>夏
                                            </option>
                                            <option value="4"
                                                {{ $modify_anime_request->coor == 4 ? 'selected' : '' }}>秋
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="public_url"
                                            value="{{ $modify_anime_request->public_url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式twitterID</th>
                                    <td>{{ '@' . $modify_anime_request->anime->twitter }}</td>
                                    <td>@<input type="text" name="twitter" value="{{ $modify_anime_request->twitter }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ハッシュタグ</th>
                                    ...
                                    <td>#<input type="text" name="hash_tag"
                                            value="{{ $modify_anime_request->hash_tag }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>舞台</th>
                                    ...
                                    <td><input type="text" name="city_name"
                                            value="{{ $modify_anime_request->city_name }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>制作会社1</th>
                                    ...
                                    <td><input type="text" name="company1"
                                            value="{{ $modify_anime_request->company1 }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>制作会社2</th>
                                    <td>{{ $modify_anime_request->anime->companies[1]->name ?? '' }}</td>
                                    <td><input type="text" name="company2"
                                            value="{{ $modify_anime_request->company2 }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>制作会社3</th>
                                    <td>{{ $modify_anime_request->anime->companies[2]->name ?? '' }}</td>
                                    <td><input type="text" name="company3"
                                            value="{{ $modify_anime_request->company3 }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>放送カテゴリー</th>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="fod_id" value="{{ $modify_anime_request->fod_id }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>U-NEXTのID</th>
                                    <td>{{ $modify_anime_request->anime->unext_id }}</td>
                                    <td><input type="text" name="unext_id"
                                            value="{{ $modify_anime_request->unext_id }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ABEMAプレミアムのID</th>
                                    <td>{{ $modify_anime_request->anime->abema_id }}</td>
                                    <td><input type="text" name="abema_id"
                                            value="{{ $modify_anime_request->abema_id }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>DISNEY+のID</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="summary" class="summary" rows="3">{{ $modify_anime_request->summary }}</textarea><br>
                                    </td>
                                </tr>
                                <tr>
                                    <th>事由</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="furigana"
                                            value="{{ $add_anime_request->furigana }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>略称</th>
                                    <td><input type="text" name="title_short"
                                            value="{{ $add_anime_request->title_short }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>放送年</th>
                                ...
                                <tr>
                                    <th>公式HPのURL</th>
                                    <td><input type="text" name="public_url"
                                            value="{{ $add_anime_request->public_url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式twitterID</th>
                                    <td>@<input type="text" name="twitter" value="{{ $add_anime_request->twitter }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ハッシュタグ</th>
                                    <td><input type="text" name="hash_tag"
                                            value="{{ $add_anime_request->hash_tag }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>舞台</th>
                                    <td><input type="text" name="city_name"
                                            value="{{ $add_anime_request->city_name }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>制作会社1</th>
                                    <td><input type="text" name="company1"
                                            value="{{ $add_anime_request->company1 }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>制作会社2</th>
                                    <td><input type="text" name="company2"
                                            value="{{ $add_anime_request->company2 }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>制作会社3</th>
                                    <td><input type="text" name="company3"
                                            value="{{ $add_anime_request->company3 }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>放送カテゴリー</th>
                                ...
                                <tr>
                                    <th>FODのID</th>
                                    <td><input type="text" name="fod_id" value="{{ $add_anime_request->fod_id }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>U-NEXTのID</th>
                                    <td><input type="text" name="unext_id"
                                            value="{{ $add_anime_request->unext_id }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ABEMAプレミアムのID</th>
                                    <td><input type="text" name="abema_id"
                                            value="{{ $add_anime_request->abema_id }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>DISNEY+のID</th>
                                ...
                                <tr>
                                    <th>あらすじ</th>
                                    <td>
                                        <textarea name="summary" class="summary" rows="3" cols="100">{{ $add_anime_request->summary }}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th>事由</th>
                        ...
                        <table class="modify_cast_request_list_table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="name" value="{{ $modify_cast_request->name }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ふりがな</th>
                                    ...
                                    <td><input type="text" name="furigana"
                                            value="{{ $modify_cast_request->furigana }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>性別</th>
                                    ...
                                    <td>
                                        <select name="sex">
                                            <option value=""
                                                {{ is_null($modify_cast_request->sex) ? 'selected' : '' }}>-
                                            </option>
                                            <option value="1"
                                                {{ $modify_cast_request->sex == 1 ? 'selected' : '' }}>男性
                                            </option>
                                            <option value="2"
                                                {{ $modify_cast_request->sex == 2 ? 'selected' : '' }}>女性
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="birthplace"
                                            value="{{ $modify_cast_request->birthplace }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>血液型</th>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="office"
                                            value="{{ $modify_cast_request->office }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式HP</th>
                                    <td>{{ $modify_cast_request->cast->url }}</td>
                                    <td><input type="text" name="url" value="{{ $modify_cast_request->url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ツイッター</th>
                                    ...
                                    <td>@<input type="text" name="twitter"
                                            value="{{ $modify_cast_request->twitter }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ブログ</th>
                                    <td>{{ $modify_cast_request->cast->blog }}</td>
                                    <td><input type="text" name="blog" value="{{ $modify_cast_request->blog }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ブログURL</th>
                                    <td>{{ $modify_cast_request->cast->blog_url }}</td>
                                    <td><input type="text" name="blog_url"
                                            value="{{ $modify_cast_request->blog_url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>事由</th>
                    ...
                    <div class="table-responsive">
                        <table class="add_cast_request_list_table">
                            <tbody>
                                ...
                                <tr>
                                    <th>名前</th>
                                    <td><input type="text" name="name" value="{{ $add_cast_request->name }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ふりがな</th>
                                    <td><input type="text" name="furigana"
                                            value="{{ $add_cast_request->furigana }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>性別</th>
                                    <td>
                                        <select name="sex">
                                            <option value=""
                                                {{ is_null($add_cast_request->sex) ? 'selected' : '' }}>-
                                            </option>
                                ...
                                <tr>
                                    <th>出身地</th>
                                    <td><input type="text" name="birthplace"
                                            value="{{ $add_cast_request->birthplace }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>血液型</th>
                                ...
                                <tr>
                                    <th>ツイッター</th>
                                    <td>@<input type="text" name="twitter" value="{{ $add_cast_request->twitter }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ブログ</th>
                                    <td><input type="text" name="blog" value="{{ $add_cast_request->blog }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ブログURL</th>
                                    <td><input type="text" name="blog_url"
                                            value="{{ $add_cast_request->blog_url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>事由</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="name"
                                            value="{{ $modify_creater_request->name }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ふりがな</th>
                                    ...
                                    <td><input type="text" name="furigana"
                                            value="{{ $modify_creater_request->furigana }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>性別</th>
                                    ...
                                    <td>
                                        <select name="sex">
                                            <option value=""
                                                {{ is_null($modify_creater_request->sex) ? 'selected' : '' }}>-
                                            </option>
                                            <option value="1"
                                                {{ $modify_creater_request->sex == 1 ? 'selected' : '' }}>
                                                男性
                                            </option>
                                            <option value="2"
                                                {{ $modify_creater_request->sex == 2 ? 'selected' : '' }}>
                                                女性
                                            </option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="birth"
                                            value="{{ $modify_creater_request->birth }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>出身地</th>
                                    ...
                                    <td><input type="text" name="birthplace"
                                            value="{{ $modify_creater_request->birthplace }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>血液型</th>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="url"
                                            value="{{ $modify_creater_request->url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ツイッター</th>
                                    ...
                                    <td>@<input type="text" name="twitter"
                                            value="{{ $modify_creater_request->twitter }}"></td>
                                </tr>
                                <tr>
                                    <th>公式ブログ</th>
                                    <td>{{ $modify_creater_request->creater->blog }}</td>
                                    <td><input type="text" name="blog"
                                            value="{{ $modify_creater_request->blog }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ブログURL</th>
                                    ...
                                    <td><input type="text" name="blog_url"
                                            value="{{ $modify_creater_request->blog_url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>事由</th>
                    ...
                    <div class="table-responsive">
                        <table class="add_creater_request_list_table">
                            <tbody>
                                ...
                                <tr>
                                    <th>名前</th>
                                    <td><input type="text" name="name" value="{{ $add_creater_request->name }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ふりがな</th>
                                    <td><input type="text" name="furigana"
                                            value="{{ $add_creater_request->furigana }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>性別</th>
                                    <td>
                                        <select name="sex">
                                            <option value=""
                                                {{ is_null($add_creater_request->sex) ? 'selected' : '' }}>-
                                            </option>
                                            <option value="1"
                                                {{ $add_creater_request->sex == 1 ? 'selected' : '' }}>男性
                                            </option>
                                            <option value="2"
                                                {{ $add_creater_request->sex == 2 ? 'selected' : '' }}>女性
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>出身地</th>
                                    <td><input type="text" name="birthplace"
                                            value="{{ $add_creater_request->birthplace }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>血液型</th>
                                ...
                                <tr>
                                    <th>公式HP</th>
                                    <td><input type="text" name="url" value="{{ $add_creater_request->url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>ツイッター</th>
                                    <td>@<input type="text" name="twitter"
                                            value="{{ $add_creater_request->twitter }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ブログ</th>
                                    <td><input type="text" name="blog" value="{{ $add_creater_request->blog }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>公式ブログURL</th>
                                    <td><input type="text" name="blog_url"
                                            value="{{ $add_creater_request->blog_url }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>事由</th>
