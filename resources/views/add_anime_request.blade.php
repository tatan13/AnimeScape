                ...
                <table class="add_anime_request_table">
                    <tbody>
                        ...
                        <tr>
                            <th>あらすじ</th>
                            <td>
                                <textarea name="summary" class="summary" rows="3" cols="100">{{ old('summary') }}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>事由</th>
                            <td><input type="text" name="remark" size="100" class="remark" style="height: 100%; width: 100%"
                                    value="{{ old('remark') }}">
                            </td>
                        </tr>
                    </tbody>
