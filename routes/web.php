...
Route::get('/user_information/{uid}', [App\Http\Controllers\UserController::class, 'show'])->name('user.show');

Route::get('/user_information/{uid}/will_watch_anime_list', [App\Http\Controllers\UserController::class, 'showWillWatchAnimeList'])->name('user_will_watch_anime_list.show');

Route::get('/user_information/{uid}/like_user_list', [App\Http\Controllers\UserController::class, 'showUserLikeUserList'])->name('user_like_user_list.show');

Route::get('/user_information/{uid}/liked_user_list', [App\Http\Controllers\UserController::class, 'showUserLikedUserList'])->name('user_liked_user_list.show');

Route::get('/user_information/{uid}/like_cast_list', [App\Http\Controllers\UserController::class, 'showUserLikeCastList'])->name('user_like_cast_list.show');

Route::get('/user_information/{uid}/statistics', [App\Http\Controllers\UserController::class, 'showUserStatistics'])->name('user_statistics.show');
